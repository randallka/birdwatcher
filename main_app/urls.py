...
urlpatterns = [
    ...
    path('birds/<int:bird_id>/addsighting/',
    ...
    path('locations/create/', views.LocationCreate.as_view(),
         name='locations_create'),
    path('locations/<int:pk>/update/',
         views.LocationUpdate.as_view(), name='locations_update'),
    path('locations/<int:pk>/delete/',
         views.LocationDelete.as_view(), name='locations_delete'),
    path('locations/<int:location_id>/assoc_bird/<int:bird_id>/',
         views.assoc_bird, name='assoc_bird'),
    path('locations/<int:location_id>/remove_bird/<int:bird_id>/',
         views.remove_bird, name='remove_bird'),
]
